...
CLIENT_ID = json.loads(
    open(g_secret_path, 'r').read())['web']['client_id']
...
def fbconnect():
    ...
    app_id = json.loads(open(fb_secret_path, 'r').read())['web']['app_id']
    app_secret = json.loads(
        open(fb_secret_path, 'r').read())['web']['app_secret']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(g_secret_path, scope='')
